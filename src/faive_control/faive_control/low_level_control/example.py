...
def main():
    ...
    joint3 = tkinter.Scale(root, from_=0, to=80, orient="horizontal")
    joint4 = tkinter.Scale(root, from_=0, to=90, orient="horizontal")
    joint5 = tkinter.Scale(root, from_=0, to=80, orient="horizontal")
    joint6 = tkinter.Scale(root, from_=0, to=90, orient="horizontal")
    joint7 = tkinter.Scale(root, from_=0, to=80, orient="horizontal")
    joint8 = tkinter.Scale(root, from_=0, to=90, orient="horizontal")
    joint9 = tkinter.Scale(root, from_=0, to=80, orient="horizontal")
