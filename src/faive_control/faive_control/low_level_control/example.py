...
def main():
    ...
    joint0 = tkinter.Scale(root, from_=0, to=70, orient="horizontal")
    joint1 = tkinter.Scale(root, from_=-180, to=0, orient="horizontal")
    joint2 = tkinter.Scale(root, from_=0, to=90, orient="horizontal")
    joint3 = tkinter.Scale(root, from_=0, to=90, orient="horizontal")
    joint4 = tkinter.Scale(root, from_=0, to=90, orient="horizontal")
    joint5 = tkinter.Scale(root, from_=0, to=90, orient="horizontal")
    joint6 = tkinter.Scale(root, from_=0, to=90, orient="horizontal")
    joint7 = tkinter.Scale(root, from_=0, to=90, orient="horizontal")
    joint8 = tkinter.Scale(root, from_=0, to=90, orient="horizontal")
    joint9 = tkinter.Scale(root, from_=0, to=90, orient="horizontal")
